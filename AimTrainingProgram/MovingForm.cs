...
namespace AimTrainingProgram
{
    public partial class MovingForm : Form
    {
        ...
        private const int BLITZ_Q_RANGE = 350;     // 발사체 최대 사거리
        ...
        private float projectileScale = 0.1f;
        ...
        public MovingForm(Form previousForm)
        {
            ...
            {
                new TargetType(Properties.Resources.morgana, 5f),
                //new TargetType(Properties.Resources.blitz, 10f),
                new TargetType(Properties.Resources.malphite, 10f)
            };
        ...
        {
            botLocation = GetRandomPositionInRange(player.Location, BLITZ_Q_RANGE);
        ...
        private void ProjectileTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (Distance(botLocation, Point.Round(projectilePosition)) > BLITZ_Q_RANGE)
            {
                projectileTimer.Stop();
                isProjectileActive = false;
                attempts++;
